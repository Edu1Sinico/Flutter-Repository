// ignore_for_file: constant_identifier_names, depend_on_referenced_packages, unnecessary_import, file_names
...
class DatabaseHelper {
  ...
  static const String CREATE_CONSTACTS_TABLE_SCRIPT =
      "CREATE TABLE users(id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT UNIQUE, email TEXT UNIQUE, password TEXT)";
